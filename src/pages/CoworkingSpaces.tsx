      ...
      <section className="container mx-auto px-4 py-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="md:col-span-2">
                  <div className="relative">
                    ...
                    <Input placeholder="Search spaces by name or location..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-9" />
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredSpaces.length === 0 ? <div className="col-span-full text-center py-12">
            ...
            </div> : filteredSpaces.map(space => <StandardCard key={space.id} className="overflow-hidden group">
              ...
              <CardContent>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {space.amenities.slice(0, 3).map((amenity, index) => <Badge key={index} variant="outline" className="text-xs">
                      {amenity === "High-Speed WiFi" && <Wifi className="w-3 h-3 mr-1" />}
                      {amenity === "Cafe" && <Coffee className="w-3 h-3 mr-1" />}
                      {amenity}
                    </Badge>)}
                  {space.amenities.length > 3 && <Badge variant="outline" className="text-xs">
